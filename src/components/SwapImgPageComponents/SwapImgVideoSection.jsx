...
import swapSectionVideoImg from "@/public/assets/swapSectionVideoImg.png";
import colorizeImgVideoIcon from "@/public/assets/colorizeImgVideoIcon.png";

const SwapImgVideoSection = () => {
  return (
...
export default SwapImgVideoSection;
