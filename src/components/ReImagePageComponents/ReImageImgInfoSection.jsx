...
import reImageSectionInfoImg from "@/public/assets/reImageSectionInfoImg.png";
import Image from "next/image";

const ReImageImgInfoSection = () => {
  return (
...
export default ReImageImgInfoSection;
