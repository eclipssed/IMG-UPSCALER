...
import replaceBGSectionDetailImg1 from "@/public/assets/replaceBGSectionDetailImg1.png";
import replaceBGSectionDetailImg2 from "@/public/assets/replaceBGSectionDetailImg2.png";
import replaceBGSectionDetailImg3 from "@/public/assets/replaceBGSectionDetailImg3.png";
import React from "react";

const ReplaceBGImgDetailsSection = () => {
  return (
      ...
      <div className="wrapper py-8">
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-16 my-16">
          <div className="mx-auto">
            <Image
              alt="img"
              src={replaceBGSectionDetailImg1}
              height={483}
              width={530}
            />
          </div>
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-16 my-16">
          ...
          <div className="mx-auto">
            <Image
              alt="img"
              src={replaceBGSectionDetailImg2}
              height={483}
              width={530}
            />
          </div>
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-16 my-16">
          <div className="mx-auto">
            <Image
              alt="img"
              src={replaceBGSectionDetailImg3}
              height={483}
              width={530}
            />
          </div>
...
export default ReplaceBGImgDetailsSection;
