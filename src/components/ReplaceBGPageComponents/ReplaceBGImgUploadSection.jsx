...
import replaceBGSectionHeroImg from "@/public/assets/replaceBGSectionHeroImg.png";
...
const ReplaceBGImgUploadSection = () => {
  const [image, setImage] = useState("");
  const [previewImage, setPreviewImage] = useState("");
  const replaceBgApi = "https://clipdrop-api.co/replace-background/v1";
...
export default ReplaceBGImgUploadSection;
