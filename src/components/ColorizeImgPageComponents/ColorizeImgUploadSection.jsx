...
import colorizeSectionHeroImg from "@/public/assets/colorizeSectionHeroImg.png";
...
const ColorizeImgUploadSection = () => {
  const [image, setImage] = useState("");
  const [previewImage, setPreviewImage] = useState("");
  const colorizeImgApi = "https://clipdrop-api.co/reimagine/v1/reimagine";
    ...
    <section className="wrapper">
      <div className="text-center my-8 ">
        <h2 className="text-2xl font-semibold">
          One-Click Colorizer your Image with img upscaler{" "}
        </h2>
        <p>Now you can get a colorize any image with img upscaler easily</p>
      </div>
...
export default ColorizeImgUploadSection;
